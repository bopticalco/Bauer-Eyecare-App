...
const ContactLensCaseIcon: React.FC<any> = (props) => {
  return React.createElement('svg', {
    ...
    // Left circle
    React.createElement('circle', { cx: "7", cy: "12", r: "5" }),
    // Right circle
    React.createElement('circle', { cx: "17", cy: "12", r: "5" }),
    // Connection bridge
    React.createElement('path', { d: "M12 12h0" }), // Visual bridge handled by circle overlap or specific path if needed, but simplistic figure-8:
    React.createElement('path', { d: "M10.5 8.5C11 8.5 11.5 9 12 9C12.5 9 13 8.5 13.5 8.5" }), // Top bridge
    React.createElement('path', { d: "M10.5 15.5C11 15.5 11.5 15 12 15C12.5 15 13 15.5 15.5" }), // Bottom bridge
    
    // Letters
    React.createElement('text', { x: "5.5", y: "13", fontSize: "4", stroke: "none", fill: "currentColor", fontWeight: "bold" }, "R"),
    React.createElement('text', { x: "15.5", y: "13", fontSize: "4", stroke: "none", fill: "currentColor", fontWeight: "bold" }, "L")
  );
};
...
const EmailQuestionIcon: React.FC<any> = (props) => {
  return React.createElement('svg', {
    ...
    // Question mark
    React.createElement('path', { d: "M19.5 10a1.5 1.5 0 1 0-1.2 2.3c.3.1.5.6.5 1v.2", stroke: "currentColor", strokeWidth: "2" }),
    React.createElement('circle', { cx: "19", cy: "16", r: "0.5", fill: "currentColor", stroke: "none" }) 
  );
};
